            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    >
                        ...
                        <p className="text-zinc-400">The LNM Institute of Information Technology (LNMIIT), Jaipur</p>
                        <p className="text-sm text-zinc-500 mt-4 leading-relaxed italic">
                            Focused on backend engineering, data structures, and modern AI/ML systems. Active in research and development of scalable backend systems and machine learning pipelines.
                        </p>
                    </motion.div>
                </div>
            </div>
